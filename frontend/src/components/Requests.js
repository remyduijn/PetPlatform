            ...
            return (
              <>
                <tr>
                  ...
                  <td>{currRequesterData?.status === "unfulfilled" ? <tb className="d-flex align-content-center"><button className='btn btn-sm' onClick={()=>markedAsFullfilled(currRequesterData?.id)}>Mark as Fulfilled</button></tb> : <tb className="d-flex align-content-center">{currRequesterData?.status}</tb>}</td>
